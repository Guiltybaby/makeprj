...
#ifdef __ZOS__tbase__
#include "taStd.h"
#endif

#if defined(__ZOS__watch__) || defined(__ZOS__beanpod__)  || defined(__ZOS__qsee__)  || defined(__ZOS__hisi__) || defined(__ZOS__tkcore__) 
#include <assert.h>
#endif
...
#else
#if defined(__ZOS__tbase__) || defined(__ZOS__watch__) || defined(__ZOS__beanpod__) || defined(__ZOS__qsee__) || defined(__ZOS__hisi__) 
assert(0);
#else
  DIR		*dir;			// Directory 
